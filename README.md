...
## Quickstart
  ...
  1. Grab a plugin release from the [releases](https://github.com/ourzora/go-ds-s3/releases) section matching your Kubo version and install the plugin file in `~/.ipfs/plugins`.
